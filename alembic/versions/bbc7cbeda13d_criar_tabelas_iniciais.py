...
Revision ID: bbc7cbeda13d
Revises: 
Create Date: 2026-09-04 10:49:30.831633
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'REGULAR', name='user_roles'), nullable=False),
    ...
    op.create_index(op.f('ix_monitored_products_id'), 'monitored_products', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_monitored_products_id'), table_name='monitored_products')
